      ...
      body: Stack(
        children: [
          MobileScanner(
            ...
            onDetect: (capture) => _handleQrDetection(capture),
          ),
          LayoutBuilder(
            builder: (context, constraints) => Center(
              child: CustomPaint(
                size: Size((constraints.maxHeight < constraints.maxWidth ? constraints.maxHeight : constraints.maxWidth) * 4 / 5, (constraints.maxHeight < constraints.maxWidth ? constraints.maxHeight : constraints.maxWidth) * 4 / 5),
